...
const projects = [
  {
    ...
    imageUrl: './assets/can we talk.png',
  },
  {
    id: '2',
    title: 'Instagram graphics',
    category: 'Graphic Design',
    imageUrl: './assets/instagram graphics.png',
  },
  {
    id: '3',
    title: 'Ad Design',
    category: 'Graphics Design',
    imageUrl: './assets/Jumex poster.png',
  },
  {
    id: '4',
    title: 'Social media poster',
    category: 'Graphic Design',
    imageUrl: './assets/momohouse.png',
  },
    {
    id: '5',
  ...
  return (
    ...
    <div className="max-w-8xl mx-auto px-6 lg:px-12 mb-16 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
      ...
      {/* 
        ...
        rotate-[-2deg] gives a subtle 'tilted' gallery feel.
        perspective-[2000px] adds depth.
      */}
      <div className="relative w-full perspective-[2000px]">
        
        {/* Blur Gradients (Mask Image) */}
        <div 
           className="marquee-container flex gap-8 overflow-hidden select-none w-full py-12 -my-12 origin-center"
        >

          {/* Loop 1 (Reverse Animation) */}
          ...
          {/* Loop 2 (Reverse Animation) */}
          <div 
            className="flex animate-marquee-reverse shrink-0 items-start gap-8 min-w-full w-max" 
            aria-hidden="true"
          >
            {projects.map((project, index) => (
           ...
           {/* Loop 3 (Extra buffer for wider screens to prevent gaps) */}
          <div 
            className="flex animate-marquee-reverse shrink-0 items-start gap-8 min-w-full w-max" 
            aria-hidden="true"
          >
